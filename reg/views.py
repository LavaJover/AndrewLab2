...
def login_view(request):
    ...
    return render(request, 'reg/login_form.html', context)
...
def signup(request):
    ...
    return render(request, 'reg/signup_form.html', context)
...
def course(request, course_name):
    ...
    return render(request, 'reg/course.html', context)
...
def homework(request, hw_id):
    ...
    return render(request, 'reg/hw.html', context)
...
def main(request):
    ...
    return render(request, 'reg/main.html', context)
...
def journal(request):
    ...
    return render(request, 'reg/journal.html', context)
